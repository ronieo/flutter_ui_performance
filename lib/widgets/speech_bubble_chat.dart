...
import 'package:flutter_performance/config/asset_image.dart';
import 'package:flutter_performance/widgets/speech_bubble_left.dart';
import 'package:flutter_performance/widgets/speech_bubble_right.dart';
                        ...
                        child: Stack(
                          children: [
                            Container(
                              ...
                              height: 145,
                              padding: const EdgeInsets.only(
                                  left: 20.7, top: 33, right: 18, bottom: 17.5),
                              decoration: BoxDecoration(
                                color: GlobalColor.white,
                                border: Border.all(
                                    color: GlobalColor.white, width: 1),
