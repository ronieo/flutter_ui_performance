    ...
    return Stack(
      children: [
        Container(
          ...
          height: 100,
          padding:
              const EdgeInsets.only(left: 22, top: 10, right: 12, bottom: 10),
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final tailOutlinePath = Path()
      ...
      ..lineTo(tailStartPoint.x + (tailSize.width * -0.5),
          tailStartPoint.y + (tailSize.height * -2.5))
      ..lineTo(tailStartPoint.x + (tailSize.width * 0.05),
          tailStartPoint.y + (tailSize.height * -2.0));

    ///tail body
    final tailPath = Path()
      ..moveTo(tailStartPoint.x, tailStartPoint.y)
      ..lineTo(tailStartPoint.x + (tailSize.width * -0.49),
          tailStartPoint.y + (tailSize.height * -2.49))
      ..lineTo(tailStartPoint.x + (tailSize.width * 0.06),
          tailStartPoint.y + (tailSize.height * -2.01));
